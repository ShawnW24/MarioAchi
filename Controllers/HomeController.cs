...
namespace Dojoachi.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            HttpContext.Session.SetString("Reaction", "Keep Mario Happy !!");
        ...
        public IActionResult Feed()
        {
            ...
            if (meals > 0)
            {
                ...
                HttpContext.Session.SetString("Reaction","You Have Fed Mario!");
            }
            if(meals==0)
            {
                HttpContext.Session.SetString("Reaction","Mario Has No Meals Left!");
            }
        ...
        public IActionResult Sleep()
        {
            ...
            {
                HttpContext.Session.SetString("Reaction", "Mario Has Taken The BIG Sleep!");
